...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		//para salvar um objeto dependente na relação 1 para 1 no banco
		// não chama o repository do proprio objeto (paymentRepository)
		// faz associação em mão dupla em memória
		// chama pedido o1 passando o argumento
